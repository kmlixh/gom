...
var dsn = "root:123456@tcp(192.168.110.249:3306)/test?charset=utf8&loc=Asia%2FShanghai&parseTime=true"
...
func TestSpecial(t *testing.T) {
	ts := []Tt{
		...
		{"测试空结构体获取Map", func(t *testing.T) {
			d, er := gom.StructToMap(EmptyStruct{})
			if er == nil {
